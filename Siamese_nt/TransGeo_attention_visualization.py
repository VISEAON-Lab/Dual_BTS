...
import random
from Deit_attentio_visualization import deit_small_distilled_patch16_224
...
class TransGeo(nn.Module):
    ...
    def __init__(self,  args, base_encoder=None):
        ...
        if args.dataset == 'vigor':
            ...
            self.size_sat = [224,224]#[256,478]
            self.size_sat_default = [224, 224]
            self.size_grd = [224, 224]
        elif args.dataset == 'cvact':
            self.size_sat = [512, 512]
            self.size_sat_default = [256, 256]
            self.size_grd = [512, 968]
