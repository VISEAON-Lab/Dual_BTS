...
parser.add_argument('--resume', default=r"D:\fabian\PycharmProjects\Dual\Dino\logs\best_model.pth", type=str, metavar='PATH',
...
def main():
    ...
    main_worker(args.gpu,  args)#ngpus_per_node,
...
def main_worker(gpu,  args):#ngpus_per_node
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        r = pd.Series(acc1,index=['accuracy'])
        PD= PD.append(r, ignore_index=True)
        PD.to_csv(r"D:\fabian\PycharmProjects\transgeo1\results\accuracy.csv")
        ...
        save_checkpoint({
            ...
            }, is_best, filename='checkpoint.pth', args=args) # 'checkpoint_{:04d}.pth.tar'.format(epoch)
